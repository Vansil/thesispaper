...
\usepackage[colorlinks,linktocpage=true,linkcolor=darkblue,citecolor=darkblue,urlcolor=darkblue,bookmarks=false,hypertexnames=true]{hyperref}
...
\nocite{acknowledgements}

% \input{03samenvatting}
